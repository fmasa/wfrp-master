...
class SkillParser {
    fun import(
        ...
        buildList {
            ...
            while (stream.peek() != null) {
                ...
                val characteristic =
                    CareerCharacteristicsParser.CHARACTERISTICS.getValue(
                ...
                val advanced =
                    when (skillType.splitToSequence(",").first()) {
                        "advanced" -> true
                        "basic" -> false
                        else -> error("Expected basic/advanced as skill type, $skillType found")
                    }
                val (description, specialisations) =
                    splitSpecialisationsFromDescription(
    ...
    private fun splitSpecialisationsFromDescription(description: List<Token>): Pair<List<Token>, Sequence<String>> {
        val specialisationsTokenIndex =
            description.indexOfFirst {
