...
internal fun CompendiumSkillChooser(
    ...
    Scaffold(
        ...
        val compendiumSkills = screenModel.notUsedSkillsFromCompendium.collectWithLifecycle(null).value
        val totalCompendiumSkillCount = screenModel.compendiumSkillsCount.collectWithLifecycle(null).value
